...
function TimeMenu() {
    ...
    const SAFLIB_ADDRESS = addresses.SAFLIB_ADDRESS;
                ...
                {({ TransitionProps }) => (
                    <Fade {...TransitionProps} timeout={200}>
                        <div className="tooltip">
                            <Link className="tooltip-item" href={`https://app.bogged.finance/bsc/swap?tokenIn=BNB&tokenOut=0xE5bA47fD94CB645ba4119222e34fB33F59C7CD90`} target="_blank">
                                <p>Buy on Bog Swap</p>
                            </Link>
                            ...
                            {isEthereumAPIAvailable && (
                                <div className="add-tokens">
                                    ...
                                    <div className="divider" />
                                    <div className="tooltip-item" onClick={addTokenToWallet("SAFLIB", SAFLIB_ADDRESS)}>
                                        <p>SAFLIB</p>
                                    </div>
                                </div>
                            )}
