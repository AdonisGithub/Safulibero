    ...
    return (
        <div className="dashboard-view">
            <div className="dashboard-infos-wrap">
                <Zoom in={true}>
                    <div>
                        <div style={{backgroundColor:"#052367", border:"1px solid rgb(98 116 94)", borderRadius:"10px"}}>
                                <Grid container>                        
                                    <Grid item lg={4} md={4} sm={6} xs={12}> 
                                        <div className="dashboard-card">                      
                                            <p className="card-title">SAFLIB Price</p>
                        ...
                        <div>
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item lg={6} md={6} sm={6} xs={12}>
                                    <div className="dashboard-individual-card">
                                        <p className="card-title">SAFLIB Insurance Fund Value</p>
                                ...
                                <Grid item xs={12} sm={4} md={4} lg={4}>
                                    <div className="dashboard-individual-card">
                                        ...
                                        <p className="card-value">
                                            {     
                                                new Intl.NumberFormat().format(Number(`${trim(app.firepitBalance, 2)}`)) + " SAFLIB"
                                            }                                   
                                        </p>     
                                    </div>
                                </Grid>
