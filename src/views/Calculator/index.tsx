...
function Calculator() {
    ...
    const safuliberoBalance = useSelector<IReduxState, string>(state => {
        return state.account.balances && state.account.balances.safulibero;
    });

    const trimmedCurrentAPY = trim(currentAPY * 100, 1);
    console.log("current apy", trimmedCurrentAPY);
    const trimmedSafLibBalance = trim(Number(safuliberoBalance), 5);
    const trimeMarketPrice = trim(marketPrice, 2);

    const [safuliberoAmount, setSafLibAmount] = useState(trimmedSafLibBalance);
    ...
    const calcInitialInvestment = () => {
        const safulibero = Number(safuliberoAmount) || 0;
        const price = parseFloat(priceAtPurchase) || 0;
        const amount = safulibero * price;
    ...
    }, [days, rewardYield, futureMarketPrice, safuliberoAmount]);
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={4} md={4} lg={4}>
                                        <div className="calculator-card-apy">
                                            <p className="calculator-card-metrics-title">SAFLIB Price</p>
                                    ...
                                    <Grid item xs={6} sm={4} md={4} lg={4}>
                                        <div className="calculator-card-index">
                                            <p className="calculator-card-metrics-title">Your SAFLIB Balance</p>
                                            <p className="calculator-card-metrics-value">{isAppLoading ? <Skeleton width="100px" /> : <>{trimmedSafLibBalance} SAFLIB</>}</p>
                                        </div>
                                    </Grid>
                                </Grid>
                            </div>
                        ...
                        <div className="calculator-card-area">
                            <div>
                                    ...
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6}>
                                            <div className="calculator-card-action-area-inp-wrap">
                                                <p className="calculator-card-action-area-inp-wrap-title">SAFLIB Amount</p>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                                    value={safuliberoAmount}
                                                    onChange={e => setSafLibAmount(e.target.value)}
                                                    labelWidth={0}
                                                    endAdornment={
                                                        <InputAdornment position="end">
                                                            <div onClick={() => setSafLibAmount(trimmedSafLibBalance)} className="stake-card-action-input-btn">
                                                                <p>Max</p>
                                                            </div>
                                                        </InputAdornment>
                                                    }
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <div className="calculator-card-action-area-inp-wrap">
                                                <p className="calculator-card-action-area-inp-wrap-title">SAFLIB price at purchase ($)</p>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <div className="calculator-card-action-area-inp-wrap">
                                                <p className="calculator-card-action-area-inp-wrap-title">Future SAFLIB market price ($)</p>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                ...
                                <div className="calculator-user-data">
                                    ...
                                    <div className="data-row">
                                        <p className="data-row-name">SAFLIB rewards estimation</p>
                                        <p className="data-row-value">{isAppLoading ? <Skeleton width="80px" /> : <>{rewardsEstimation} SAFLIB</>}</p>
                                    </div>
                                    <div className="data-row">
